...
This folder contains the current data-processing scripts, local raw inputs, generated GRDC Major River Basin data, and exploratory grid viewer.

## Contents

- `src/build_basin_time_series.py`: builds the 1962-2016 GRDC major-river-basin time series used by Figure 2 and the Tereon module.
...
- `src/build_basins.py`: downloads GRDC Major River Basins and prepares basin boundary data plus WaterGAP cell membership for map overlays and paper figures.
...
- `basin-data.js`: generated GRDC Major River Basin overlay data used by both the viewer and paper figures.
